...
class Constant {
    ...
    companion object {
        ...
        val menuLists = arrayListOf<Menu> (
                Menu( "教務事務システム", MenuLists.courseManagementHomePC, "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/sp/Top.aspx"),
                ...
                Menu( "生協営業状況", MenuLists.tokudaiCoop,"https://tokudai.marucoop.com/#parts"),
                Menu( "シラバス", MenuLists.syllabus,""),
                Menu( "今期の成績", MenuLists.currentTermPerformance,"https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/Sp/ReferResults/SubDetail/Results_Get_YearTerm.aspx?year="),
                Menu( "メール", MenuLists.mailService,"https://outlook.office365.com/tokushima-u.ac.jp"),
